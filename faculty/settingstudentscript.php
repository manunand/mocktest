...
$query="insert into student_login(username,password,privilege,reg_no) values('$username1','$password',1,'$reg_no1')";
...
if(mysqli_affected_rows($conn)>0) {
	...
	<div class="alert alert-danger">
  		...
  		<meta http-equiv="refresh" content="7;url=settingstudent.php" />
	</div>
	<?php
} 
}
