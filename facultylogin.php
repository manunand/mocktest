...
<html>
<head>
  <title>Mock Test | Faculty Login</title>
  <style type="text/css">
    .content {
        max-width: 500px;
        margin: auto;
      ...
      <div class="content w3-animate-top " style="padding-top: 2%">
        <div class="w3-card-4" style="padding-top: 8%;border:solid thin black;border-radius: 10px;border-color: green;box-shadow: 1px 1px 90px #fff;background-color:  #eef9f7  ;">
          <div class="w3-container" align="center">
            <h2><b>Faculty Login</b></h2><br><br>
          </div>
          <form action="facultyloginscript.php" method="POST">
            ...
            <div align="center">
              <button class="btn btn-primary btn-lg" name="submit" onclick="errormessage" type="submit">Submit</button><br><br><br>
            </div>
          </form>
        </div>
      </div>
        ...
        <script >
          function errormessage(){
            ...
            error.innerHTML = "<span style='color:red;'>"+"Please enter valid  number</span"
          }else{
            error.innerHTML= ""
          }
          }
